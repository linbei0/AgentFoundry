...
This manual smoke task verifies that `haagent run --provider openai` can send tool schemas to a real model, receive a provider tool call, execute `fake_tool`, and preserve the episode trace for inspection.
